...
//#endregion
//#region node_modules/.pnpm/@deepseek-ai+dsh-session@0._54d1a918d77e481567353c23a9e2039f/node_modules/@deepseek-ai/dsh-session/lib/types/types.js
/**
...
var BtwController = class {
	state = (0, __deepseek_ai_dsh_client_store.createSnapshotStore)(CLOSED);
	active;
	disposed = false;
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						state.status === "success" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(__deepseek_ai_dsh_client_ui_primitives.MarkdownText, {
							text: state.response,
